...
namespace MM.Pages.Report
{
    ...
    public class ActiveIndividualPerGradeModel : PageModel
    {
        #region Constructor
        ...
        private readonly ILogger<ActiveIndividualPerGradeModel> _logger;
        private readonly IEmailCreator _emailCreator;
        private readonly IConfiguration _configuration;
        private IActivity _activity;
        private string EntityName = "Active Individual Members Per Grade";

        public ActiveIndividualPerGradeModel(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager,
            ILogger<ActiveIndividualPerGradeModel> logger, IEmailCreator emailCreator, ClientDbContext clientDbContext, IConfiguration configuration, IActivity activity)
        {
        ...
        public async Task<IActionResult> OnGetListAsync()
        {
            ...
            var members = await _clientDbContext.MemberUser
                ...
                .Include(x => x.ClientBranch).OrderBy(x=>x.MembershipGrade.Name).Where(x=>x.MemberStatus.Name.ToUpper()=="ACTIVE")
                .ToListAsync();
            int i = 0;
            int d = 0;
