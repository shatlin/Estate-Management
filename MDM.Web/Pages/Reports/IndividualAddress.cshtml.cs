...
namespace MM.Pages.Report
{
    ...
    public class IndividualAddressModel : PageModel
    {
        #region Constructor
        ...
        private readonly ILogger<IndividualAddressModel> _logger;
        private readonly IEmailCreator _emailCreator;
        private readonly IConfiguration _configuration;
        private IActivity _activity;
        private string EntityName = "Resigned Members";

        public IndividualAddressModel(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager,
            ILogger<IndividualAddressModel> logger, IEmailCreator emailCreator, ClientDbContext clientDbContext, IConfiguration configuration, IActivity activity)
        {
        ...
        public async Task<IActionResult> OnGetListAsync()
        {
            ...
            foreach (var member in members)
            {
                ...
                try
                {
                    ...
                    //    avm.PhysicalAddressLine3 = PhysicalAddress.AddressLine2;
                    ...
                    if (PostalAddress != null)
                    {
                        ...
                        avm.PostalPostalCode = PostalAddress.PostalCode;
                            avm.PostalCountryName = PostalAddress.CountryName;
                    }
