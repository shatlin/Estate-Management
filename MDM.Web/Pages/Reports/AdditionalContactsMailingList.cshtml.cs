...
namespace MM.Pages.Report
{
    ...
    public class AddtionalContactsMailingListModel : PageModel
    {
        #region Constructor
        ...
        private readonly ILogger<AddtionalContactsMailingListModel> _logger;
        private readonly IEmailCreator _emailCreator;
        private readonly IConfiguration _configuration;
        private IActivity _activity;
        private string EntityName = "Members Mailing List";

        public AddtionalContactsMailingListModel(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager,
            ILogger<AddtionalContactsMailingListModel> logger, IEmailCreator emailCreator, ClientDbContext clientDbContext, IConfiguration configuration, IActivity activity)
        {
        ...
        public async Task<IActionResult> OnGetListAsync()
        {
            ...
            var members = await _clientDbContext.MemberUser
                ...
                .Include(x => x.ApplicationUser).Where(x => x.MembershipTypeId==8)
                .ToListAsync();
