...
namespace MDM.Pages
{
    ...
    public class ServiceProvidersModel :  PageBase
    {
        ...
        public ServiceProvidersModel(SignInManager<ApplicationUser> signInManager,
        ...
        {
            PageName = PageNames.ServiceProvidersPage;
        }
