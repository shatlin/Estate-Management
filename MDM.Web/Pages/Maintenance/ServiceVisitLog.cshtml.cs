...
namespace MDM.Pages
{
    ...
    public class ServiceVisitLogModel :  PageBase
    {
        ...
        public ServiceVisitLogModel(SignInManager<ApplicationUser> signInManager,
        ...
        {
            PageName = PageNames.ServiceVisitLogPage;
        }
