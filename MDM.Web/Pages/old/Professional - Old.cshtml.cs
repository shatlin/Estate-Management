...
{
    public class ProfessionalOldModel : PageModel
    {
        ...
        private readonly ILogger<ProfessionalOldModel> _logger;
        private readonly IEmailSender _emailSender;

        public ProfessionalOldModel(
            UserManager<ApplicationUser> userManager,
            SignInManager<ApplicationUser> signInManager,
            ILogger<ProfessionalOldModel> logger, RoleManager<ApplicationRole> roleManager,
