...
{
    public class ApplicationIndividualModel : PageModel
    {
        ...
        public ApplicationIndividualModel(
        ...
        public void GetAllDivisions()
        {
            ...
            var allDivisions = _clientDbContext.Divsion.ToList();
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            try { _logger.LogInformation("physicaladress.AddressLine1|" + physicaladress.AddressLine1.ToString()); } catch { _logger.LogInformation("physicaladress.AddressLine1|" + "null"); }
            try { _logger.LogInformation("physicaladress.AddressLine2|" + physicaladress.AddressLine2.ToString()); } catch { _logger.LogInformation("physicaladress.AddressLine2|" + "null"); }
            try { _logger.LogInformation("physicaladress.Suburb|" + physicaladress.Suburb.ToString()); } catch { _logger.LogInformation("physicaladress.Suburb|" + "null"); }
            try { _logger.LogInformation("physicaladress.City|" + physicaladress.City.ToString()); } catch { _logger.LogInformation("physicaladress.City|" + "null"); }
            try { _logger.LogInformation("physicaladress.Province|" + physicaladress.Province.ToString()); } catch { _logger.LogInformation("physicaladress.Province|" + "null"); }
            try { _logger.LogInformation("physicaladress.CountryId|" + physicaladress.CountryId.ToString()); } catch { _logger.LogInformation("physicaladress.CountryId|" + "null"); }
            try { _logger.LogInformation("physicaladress.PostalCode|" + physicaladress.PostalCode.ToString()); } catch { _logger.LogInformation("physicaladress.PostalCode|" + "null"); }


            try { _logger.LogInformation("postaladress.AddressLine1|" + postaladress.AddressLine1.ToString()); } catch { _logger.LogInformation("postaladress.AddressLine1|" + "null"); }
            try { _logger.LogInformation("postaladress.AddressLine2|" + postaladress.AddressLine2.ToString()); } catch { _logger.LogInformation("postaladress.AddressLine2|" + "null"); }
            try { _logger.LogInformation("postaladress.Suburb|" + postaladress.Suburb.ToString()); } catch { _logger.LogInformation("postaladress.Suburb|" + "null"); }
            try { _logger.LogInformation("postaladress.City|" + postaladress.City.ToString()); } catch { _logger.LogInformation("postaladress.City|" + "null"); }
            try { _logger.LogInformation("postaladress.Province|" + postaladress.Province.ToString()); } catch { _logger.LogInformation("postaladress.Province|" + "null"); }
            try { _logger.LogInformation("postaladress.CountryId|" + postaladress.CountryId.ToString()); } catch { _logger.LogInformation("postaladress.CountryId|" + "null"); }
            try { _logger.LogInformation("postaladress.PostalCode|" + postaladress.PostalCode.ToString()); } catch { _logger.LogInformation("postaladress.PostalCode|" + "null"); }
